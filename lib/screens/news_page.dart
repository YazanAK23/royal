...
class NewsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final newsItems = [
      NewsItem(image: 'assets/images/news1.png', title: s.news1Title),
      NewsItem(image: 'assets/images/news2.png', title: s.news2Title),
      NewsItem(image: 'assets/images/news3.png', title: s.news3Title),
    ];
...
class NewsItem {
  final String image;
  final String title;
  const NewsItem({required this.image, required this.title});
}
